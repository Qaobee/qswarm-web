...
angular.module('header.notifications', ['notificationsRestAPI', 'eventbus'])
    ...
    .directive('headerNotifications', function ($modal, $rootScope, $interval, ngAudio, notificationsRestAPI, eventbus, $timeout, $window, $filter) {
        'use strict';
        return {
            restrict: 'AE',
            ...
            templateUrl: 'templates/directives/headerNotifications.html'
        };
    });