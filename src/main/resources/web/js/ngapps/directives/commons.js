...
/**
 * @class qaobee.directives.uniqueusername
 ...
 *
 * @author Xavier MARIN
 * @class qaobee.directives.checkStrength
 ...
 */
    ...
    .directive('uiDateNoValidate', function ($filter, $log) {
        'use strict';
        return {
            require: 'ngModel',
            scope: {
 ...
 *
 * @author Xavier MARIN
 * @class qaobee.directives.passwdCheck
 * @copyright <b>QaoBee</b>.
 */
 ...
 *
 * @author Xavier MARIN
 * @class qaobee.directives.aboutPhotos
 * @copyright <b>QaoBee</b>.
 */
    .directive('aboutPhotos', function () {
        ...
        return {
            ...
            templateUrl: 'templates/directives/aboutPhotos.html'
        };
    })
