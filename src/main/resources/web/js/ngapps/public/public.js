...
angular.module('public', ['publicSignup', 'ngRoute', 'publicRestAPI', 'reCAPTCHA'])
    ...
    .config(function ($routeProvider) {
        $routeProvider.when('/', {
            ...
            templateUrl: 'templates/public/mentionslegales.html'
        }).when('/contact', {
            controller: 'ContactCtrl',
            templateUrl: 'templates/public/contact.html'
        }).when('/blog', {
            controller: 'BlogCtrl',
            templateUrl: 'templates/public/blog.html'
        }).when('/pricing', {
            controller: 'PricingCtrl',
            templateUrl: 'templates/public/pricing.html'
            ...
            templateUrl: 'templates/public/recoverpasswd.html'
        }).when('/features', {
            controller: 'FeaturesCtrl',
            templateUrl: 'templates/public/features.html'
        }).when('/offer/DISCOVERY', {
            controller: 'DiscoveryOfferCtrl',
            templateUrl: 'templates/public/offers/discovery.html'
        }).when('/offer/PREMIUM', {
            controller: 'PremiumOfferCtrl',
            templateUrl: 'templates/public/offers/premium.html'
        }).when('/offer/TEAM_PLUS', {
            controller: 'TeamPlusOfferCtrl',
            templateUrl: 'templates/public/offers/teamplus.html'
        }).when('/notPaid', {
            controller: 'NotPaidCtrl',
            templateUrl: 'templates/public/notPaid.html'
        });
    })
