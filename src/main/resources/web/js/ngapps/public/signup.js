 ...
 */
angular.module('publicSignup', ['paymentAPI', 'userInfosAPI', 'locationAPI', 'publicRestAPI'])
    ...
    .config(function ($routeProvider) {
        $routeProvider.when('/signup/:plan?', {
            ...
            templateUrl: 'templates/public/signup/signupCancel.html'
        }).when('/signup/coach/end/:id/:pid', {
            controller: 'SignupEndCtrl',
            templateUrl: 'templates/public/signup/signupEnd.html'
        });
    })
 ...
 */
    .controller('SignupEndCtrl', function ($scope, $filter, $routeParams, paymentAPI, $log) {
        $scope.billinfo = {};
