...
uis.directive('uiSelectChoices',
  ...
  return {
    ...
    templateUrl: function(tElement) {
      ...
      return 'app/components/directives/ui-select/' + theme + '/choices.tpl.html';
    },
...
uis.directive('uiSelect',
  ...
  return {
    ...
    templateUrl: function(tElement, tAttrs) {
      ...
      return 'app/components/directives/ui-select/' + theme + (angular.isDefined(tAttrs.multiple) ? '/select-multiple.tpl.html' : '/select.tpl.html');
    },
    replace: true,
    transclude: true,
...
uis.directive('uiSelectMatch', ['uiSelectConfig', function(uiSelectConfig) {
  return {
    ...
    templateUrl: function(tElement) {
      ...
      return 'app/components/directives/ui-select/' + theme + (multi ? '/match-multiple.tpl.html' : '/match.tpl.html');
    },
...
$templateCache.put("/components/directives/selectize/choices.tpl.html","<div ng-show=\"$select.open\" class=\"ui-select-choices ui-select-dropdown selectize-dropdown single\"><div class=\"ui-select-choices-content selectize-dropdown-content\"><div class=\"ui-select-choices-group optgroup\" role=\"listbox\"><div ng-show=\"$select.isGrouped\" class=\"ui-select-choices-group-label optgroup-header\" ng-bind=\"$group.name\"></div><div role=\"option\" class=\"ui-select-choices-row\" ng-class=\"{active: $select.isActive(this), disabled: $select.isDisabled(this)}\"><div class=\"option ui-select-choices-row-inner\" data-selectable=\"\"></div></div></div></div></div>");
