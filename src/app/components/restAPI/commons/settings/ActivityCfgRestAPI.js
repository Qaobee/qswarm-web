    ...
    angular.module('activityCfgRestAPI', []).value('activityCfgApiURL', '/api/1/commons/settings/activitycfg')
        ...
        .factory('activityCfgRestAPI', function ($http, activityCfgApiURL) {
            return {
                 ...
                 * @param {String} activityId : le code de l'activité
                 * @param {String} countryId : le code pays du user
                 * @param {String} positionType : Le poste du joueur
                 * @param {String} typeCarac : le type carac (physicalFolder, mentalFolder, technicalFolder)
