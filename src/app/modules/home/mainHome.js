(function () {
    ...
    angular.module('qaobee.home', [
         ...
         */
        .controller('HomeControler', function ($scope, $rootScope, $translatePartialLoader, user, meta, effectiveSrv, effectiveRestAPI, profileRestAPI, sandboxRestAPI, qeventbus, filterCalendarSrv, $timeout, $log) {
